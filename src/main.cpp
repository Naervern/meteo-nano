...
void update_params() {
  ...
  Serial.print("variable day_step value = ");
  Serial.println(day_step);  //debug
...
void setup() {
  ...
  if (!bmp280.begin()) Serial.println("BMP280 not detected. Please check wiring.");
  else Serial.println("BMP280 check OK!.");
  if (!aht20.begin()) Serial.println("AHT20 not detected. Please check wiring.");
